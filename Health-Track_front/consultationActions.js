...
async function loadConsultations(page = 0) {
    ...
    try {
        ...
        } else tableBody.innerHTML = `<tr><td colspan="5" class="text-center text-danger">Erro ao carregar consultas</td></tr>`;
    } catch { tableBody.innerHTML = `<tr><td colspan="5" class="text-center text-danger">Falha na conexão</td></tr>`; }
}
