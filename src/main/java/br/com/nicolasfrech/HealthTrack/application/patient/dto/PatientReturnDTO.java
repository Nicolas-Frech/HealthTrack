...
public record PatientReturnDTO(Long id, String name, String cpf, String telephone, Integer age, String email, Boolean active) {
    public PatientReturnDTO(Patient patient) {
        this(patient.getId(), patient.getName(), patient.getCpf(), patient.getTelephone(),
                patient.getAge(), patient.getEmail(), patient.getActive());
    }
}
